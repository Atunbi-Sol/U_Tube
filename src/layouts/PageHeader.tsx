...
export function PageHeader() {
  ...
  return (
    <div className="flex gap-10 lg:gap-20 justify-between pt-2 mb-6 mx-4">
      ...
      <div className={`flex-shrink-0 md:gp-2 ${showFullWidthSearch ? "hidden" : "flex"}`}>
        <Button onClick={() => setShowFullWidthSearch(true)} type="button" size="icon" className="md:hidden">
          <Search />
        </Button>
